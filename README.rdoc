...
anywhere, hence the name. One use case would be to give you access
to routing in your rake tasks and mailers.

Caveat emptor: If you feel the need for this, you're quite possibly doing 
it wrong.
